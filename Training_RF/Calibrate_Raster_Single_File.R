...
# Set up
FileOrigin <- '/home/ubuntu/Data/WorldPop_Population_Endemic/A.tif'
...
Method_reproject <- 'bilinear' # Because population is a continuous values
Method_aggregate <- 'sum' # Because the population of bigger resolution = sum of all population of smaller pixel within the large resolution
